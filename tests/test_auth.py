...
with open(Path(__file__).parent / "data" / "users.json") as f:
    invalid_users = json.load(f)
...
class TestLoginSuccess:
    ...
    def test_nav_shows_username_after_login(self, login_page, driver, base_url):
        ...
        assert "Admin User" in dashboard.get_user_name()
...
class TestLoginFailure:
    ...
    def test_invalid_login(self, login_page, credentials):
